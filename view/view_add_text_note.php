...
<body>
    <form method="post" action="note/save_add_text_note">
        <div class="edit">
            <a class="back" href="<?= $_SESSION['previous_page'] ?>"><span
        ...
        <input type="text" class="title_edit_note" id="title" name="title" placeholder="Enter note title" value="<?= $title ?>">
        <div id="titleError" class="invalid-feedback" style="display: none;"></div>

        <label for="content" class="note_body_title">Text</label>
        <textarea class="note_body_text" id="content" name="content"><?= $content ?></textarea>
