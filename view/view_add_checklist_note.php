    ...
    <form method="post" action="note/add_checklist_note">
        ...
        <div class="container add_checklist">
            <div class="mb-3">
                ...
                <input type="text" class="form-control title_add <?= (!empty($errors['title']) ? "border border-danger" : (isset($_POST["title"]) && !empty($_POST["title"]) ? "border border-success" : "")) ?>" name="title" value="<?= isset($_POST["title"]) ? htmlspecialchars($_POST["title"]) : "" ?>">
