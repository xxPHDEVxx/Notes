...
class ControllerUser extends Controller {
    ...
    public function my_archives() : void {
        ...
        (new View("archives"))->show(["currentPage"=> "my_archives",
        "archives"=>$archives, "sharers"=>$user->shared_by()]);
    }
    ...
    public function get_shared_by() : void {
        ...
        (new View("shared_notes"))->show(["currentPage" => $shared_by_name, 
        "shared_by_name"=>$shared_by_name, "shared_notes_as_editor" =>$shared_notes_as_editor,
